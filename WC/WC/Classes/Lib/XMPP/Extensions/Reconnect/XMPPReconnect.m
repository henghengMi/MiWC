...
// SCNetworkConnectionFlags was renamed to SCNetworkReachabilityFlags1 in 10.6
...
- (void)maybeAttemptReconnectWithReachabilityFlags:(SCNetworkReachabilityFlags1)reachabilityFlags;
...
- (void)xmppStreamDidDisconnect:(XMPPStream *)sender withError:(NSError *)error
{
	...
	if ([self autoReconnect] && [self shouldReconnect])
	{
		...
		SCNetworkReachabilityFlags1 reachabilityFlags = 0;
...
static void XMPPReconnectReachabilityCallback(SCNetworkReachabilityRef target, SCNetworkReachabilityFlags1 flags, void *info)
{
	@autoreleasepool {
...
- (void)maybeAttemptReconnect
{
	...
	if (reachability)
	{
		SCNetworkReachabilityFlags1 reachabilityFlags;
